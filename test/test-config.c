...
START_TEST(config_buttons_get_defaults)
{
	...
	ck_assert_int_eq(touchpad_config_get(dev->touchpad,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_LEFT, &values[0],
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_RIGHT, &values[1],
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_TOP, &values[2],
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_BOTTOM, &values[3],
					     TOUCHPAD_CONFIG_NONE), 0);
...
START_TEST(config_buttons_set_invalid)
{
	...
	ck_assert_int_eq(touchpad_config_set(dev->touchpad, &error,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_LEFT, 101,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_RIGHT, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_TOP, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_BOTTOM, 0,
					     TOUCHPAD_CONFIG_NONE), 1);
	ck_assert_int_eq(error, TOUCHPAD_CONFIG_ERROR_VALUE_TOO_HIGH);

	ck_assert_int_eq(touchpad_config_set(dev->touchpad, &error,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_LEFT, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_RIGHT, 101,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_TOP, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_BOTTOM, 0,
	...
	ck_assert_int_eq(touchpad_config_set(dev->touchpad, &error,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_LEFT, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_RIGHT, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_TOP, 101,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_BOTTOM, 0,
	...
	ck_assert_int_eq(touchpad_config_set(dev->touchpad, &error,
					     ...
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_RIGHT, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_TOP, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_BOTTOM, 101,
					     TOUCHPAD_CONFIG_NONE), 4);
	ck_assert_int_eq(error, TOUCHPAD_CONFIG_ERROR_VALUE_TOO_HIGH);

	ck_assert_int_eq(touchpad_config_set(dev->touchpad, &error,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_LEFT, -1,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_RIGHT, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_TOP, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_BOTTOM, 0,
					     TOUCHPAD_CONFIG_NONE), 1);
	...
	ck_assert_int_eq(touchpad_config_set(dev->touchpad, &error,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_LEFT, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_RIGHT, -1,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_TOP, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_BOTTOM, 0,
					     TOUCHPAD_CONFIG_NONE), 2);
	ck_assert_int_eq(error, TOUCHPAD_CONFIG_ERROR_VALUE_TOO_LOW);
	...
	ck_assert_int_eq(touchpad_config_set(dev->touchpad, &error,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_LEFT, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_RIGHT, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_TOP, -1,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_BOTTOM, 0,
					     TOUCHPAD_CONFIG_NONE), 3);
	ck_assert_int_eq(error, TOUCHPAD_CONFIG_ERROR_VALUE_TOO_LOW);
	...
	ck_assert_int_eq(touchpad_config_set(dev->touchpad, &error,
					     ...
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_RIGHT, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_TOP, 0,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_BOTTOM, -1,
					     TOUCHPAD_CONFIG_NONE), 4);
	ck_assert_int_eq(error, TOUCHPAD_CONFIG_ERROR_VALUE_TOO_LOW);
...
START_TEST(config_buttons_set_get)
{
	...
	ck_assert_int_eq(touchpad_config_set(dev->touchpad, &error,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_LEFT, 30,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_RIGHT, 70,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_TOP, 40,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_BOTTOM, 90,
					     TOUCHPAD_CONFIG_NONE), 0);
	ck_assert_int_eq(error, TOUCHPAD_CONFIG_ERROR_NO_ERROR);
	ck_assert_int_eq(touchpad_config_get(dev->touchpad,
					     TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_LEFT, &values[0],
