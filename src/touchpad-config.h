...
enum touchpad_config_parameter {
	...
	TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_LEFT, /* in % of the width */
	TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_TOP, /* in % of the height */
	TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_RIGHT, /* in % of the touchpad width */
	TOUCHPAD_CONFIG_SOFTBUTTON_RIGHT_EDGE_BOTTOM, /* in % of the touchpad height */
